...
enum RiderType : int {
  ...
  RIDER_CAMELRIDER = 1 << 14,
  RIDER_ZEBRARIDER = 1 << 15,
  RIDER_ROOK_HT = 1 << 16,
  RIDER_ROOK_HB = 1 << 17,
  RIDER_ROOK_VL = 1 << 18,
  RIDER_ROOK_VR = 1 << 19,
  ...
  RIDER_DIAG_AT = 1 << 22,
  RIDER_DIAG_AB = 1 << 23,
  RIDER_CUSTOMS = 0x7F000000,
  RIDER_GRASSHOPPER = RIDER_GRASSHOPPER_H | RIDER_GRASSHOPPER_V | RIDER_GRASSHOPPER_D,
  RIDER_GRIFFON = RIDER_ROOK_HT | RIDER_ROOK_HB | RIDER_ROOK_VL | RIDER_ROOK_VR,
  RIDER_MANTICORE = RIDER_DIAG_DT | RIDER_DIAG_DB | RIDER_DIAG_AT | RIDER_DIAG_AB,
  HOPPING_RIDERS =  RIDER_CANNON_H | RIDER_CANNON_V | RIDER_CANNON_DIAG | RIDER_GRASSHOPPER,
  ...
  ASYMMETRICAL_RIDERS =  RIDER_HORSE | RIDER_JANGGI_ELEPHANT
                       | RIDER_GRASSHOPPER | RIDER_GRIFFON | RIDER_MANTICORE,
  NON_SLIDING_RIDERS = HOPPING_RIDERS | LAME_LEAPERS | RIDER_NIGHTRIDER | RIDER_CAMELRIDER
                       | RIDER_ZEBRARIDER | RIDER_CUSTOMS,
};

extern RiderType nonSlidingRides;
extern RiderType asymmetricalRides;
extern PieceSet nonSlidingTypes;
